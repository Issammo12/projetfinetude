    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form action="inscription.php" method="POST" >
                ...
                <input type="password" id="password_confirmation" name="password_confirmation"placeholder="Repeat password" required ><br>
                <label>Je suis:</label>
                ...
                <button action="insc.php" name="button">S'INSCRIRE</button>
